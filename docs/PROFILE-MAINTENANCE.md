...
The starting-points and first-conversation panels explain when to contact Mancar and what follows. Keep their wording aligned with the actual company process. Each project also has an expandable “Feature in Focus” view that reuses an existing captured still; keep these closed by default to preserve the single changing image in the main tour. Both new company panels have desktop/mobile animations and static reduced-motion alternatives.
