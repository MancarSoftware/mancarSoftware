...
<picture>
  <source media="(prefers-reduced-motion: reduce) and (max-width: 600px)" srcset="assets/mancar-making-mobile.png" />
  <source media="(prefers-reduced-motion: reduce)" srcset="assets/mancar-making.png" />
  <source media="(max-width: 600px)" srcset="assets/mancar-making-mobile.gif" />
  <img src="assets/mancar-making.gif" width="100%" alt="An illustrated Alma Vet design process: define the request workflow, organize the form, and connect it to the real appointment request interface." />
</picture>
...
<picture>
  ...
  <img src="assets/mancar-contact.gif" width="100%" alt="What does your team still manage manually? Show us one task you would like to improve. Contact Mancar Software on Instagram." />
</picture>
</a>
